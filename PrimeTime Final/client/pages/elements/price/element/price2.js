...
import StripeContainerSub from '../../../../components/StripeContainerSub';
var settings = {
    dots: false,
    infinite: true,
    speed: 500,
                    ...
                    <div className="price-container shadows text-center">
                        ...
                        <div>
                            <div className="price-feature-container">
                                ...
                                <div className="price-value">
                                    <h6 className="price text-center">$<span className="large">50</span>/month</h6>
                                </div>
                                {showItem ? (
                                        <StripeContainerSub/>
                                          ...
                                          <div style={{
                                            ...
                                            marginTop: "-3%"
                                              ...
                                              <button className="btn btn-default btn-white" onClick={() => setShowItem(true)}>  Purshase  </button>
                                          </div>
                                      )
                                        }
                            </div>
