...
export function JoiningScreen({
  ...
  const getStream=()=>{
    ...
    axios.get(BASE_URL+"stream/getStreamBymeetId/"+localStorage.getItem("meetid"))
            .then(res => {
  ...
  const incView=()=>{
    ...
    console.log()
    console.log("TZZZZZZZZZZZZTTT"+queryParams.get("meetId"))
  ...
  const addStream=()=>{
    const queryParams = new URLSearchParams(window.location.search);
    console.log("this is meet id queryparam"+queryParams.get('meetId'))
    if (queryParams.get('meetId')=="create")
    axios.post(BASE_URL+"stream",{meetingId:localStorage.getItem("meetid"),
    ...
    axios.get(BASE_URL+"stream/viewsInc/"+queryParams.get("meetId"))
    .then(res => {
        console.log("viewers increm")
